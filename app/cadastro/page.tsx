...
export default function Cadastro() {
  ...
  return (
    ...
    >
      <section className="w-full max-w-[1080px] min-h-[650px] grid grid-cols-1 md:grid-cols-[0.82fr_1.18fr] overflow-hidden rounded-3xl border border-[#a7a2d9]/20 bg-[#f7f5f1] shadow-2xl">
        <aside
        ...
        <div className="grid place-items-center p-6 md:p-12">
          <form className="w-full max-w-[460px]">
            ...
            <p className="mb-7 text-[#59567a] leading-relaxed">
              O currículo em PDF é obrigatório para concluir o cadastro.
            </p>
            ...
            <div className="grid gap-4">
              <div className="grid gap-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-xl border-[1.5px] border-[#e4dfd3] bg-white px-4 py-3 text-[#1d1b33] placeholder:text-[#aaa5b2] focus:border-[#7755e8] focus:outline-none focus:ring-2 focus:ring-[#7755e8]/30"
                />
              </div>
              ...
              <div className="grid gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-xl border-[1.5px] border-[#e4dfd3] bg-white px-4 py-3 pr-11 text-[#1d1b33] placeholder:text-[#aaa5b2] focus:border-[#7755e8] focus:outline-none focus:ring-2 focus:ring-[#7755e8]/30"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((v) => !v)}
                    aria-label={showPassword ? "Ocultar senha" : "Mostrar senha"}
                    className="absolute inset-y-0 right-0 flex items-center px-3 text-[#aaa5b2] hover:text-[#7755e8]"
                  >
