          ...
          {!isEditing && (
            <div className="mt-6 grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
              ...
              <section className="rounded-3xl border border-[#e7e3ee] bg-white p-5 sm:p-6">
                ...
                {/* quiz + desafio de código (seção 4.4) — modalidades separadas
                    da simulação de entrevista, que fica de fora dessa entrega */}
                <Link href="/dashboard/modalidades" className="group mt-3 flex items-center justify-between gap-4 rounded-2xl border border-[#e7e3ee] bg-white p-4 text-left transition hover:border-[#7755e8]">
                  <div><p className="font-extrabold text-[#1d1b33]">Quiz e desafio de código</p><p className="mt-1 text-xs leading-relaxed text-[#6d698a]">Teste sua teoria e pratique um problema de programação de verdade.</p></div><ArrowRight className="h-4 w-4 shrink-0 text-[#7755e8] transition group-hover:translate-x-1" />
                </Link>
